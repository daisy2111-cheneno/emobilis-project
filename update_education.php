            ...
            <form action="handle_personalinformation.php" method="post" enctype="multipart/form-data" class="main mt-3">
                ...
                <div class="row m-2">
                    ...
                    <div class="col">
                        ...
                        <input class="inputstyle form-control" type="text" name="phoneNumber" id="phoneNumber" placeholder="0700123456">
                    </div>
                </div>
                <div class="row m-2">
                    <div class="col">
                ...
                <div class="row">
                    <input type="submit" name="submit" class="bg bg-primary text-white border-0 rounded-1 mb-4 col-md-2" style="height: 37px; transform: translate(490%,0%);" value="Submit">
                </div>
                ...
                $sql_e = "SELECT * FROM `education`";

                $result_e = mysqli_query($link,$sql_e);

                if ($result_e){

                    $data_e = mysqli_num_rows($result_e);
                    ...
                    <a class='m-2' href='delete_education.php?id=".$row['id']."'><span class='fa fa-trash'></span></a>
                    <a class='m-2' href='update_education.php?id=".$row['id']."'><span class='fa fa-pencil'></span></a>
                    <a class='m-2' href='view_education.php?id=".$row['id']."'><span class='fa fa-eye'></span></a>
                    ...
                    echo "Error executing query $sql_e".mysqli_error($link);
                }
